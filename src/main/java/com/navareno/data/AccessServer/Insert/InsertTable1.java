...
//                                insertData1 = new InsertData1(weightData1, weightData2, weightData3, weightData4, subStrGPSNew[0]+"", subStrGPSNew[1]+"");
...
//                                insertData1.getConnection().close();
                            ...
                            System.out.println("получили номер датчика: " + weightNumberSensor + " данные с датчика: " + weightData1[j]);
                        }
